...
const Login = () => {
  ...
  return (
      ...
      <section>
        ...
        <article className="bg-gradient-secondary h-[100vh]">
          <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <div className="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
              <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                <Link href="/" className="flex items-center mb-6 text-2xl font-semibold text-gray-900 justify-center" title="caviglia Logo">
                    <img className="mr-2" src={logo.src} width={300} alt="CAVIGLIA logo" loading='lazy' title="caviglia Logo" />
                </Link>
                <form id='formLogin' className="space-y-4 md:space-y-6" onSubmit={handleSubmit(onSubmit)}>
                  ...
                  {/* <div className="flex items-center justify-between">
                    ...
                    <Link href="/" className="text-sm font-medium text-primary hover:underline" title="caviglia Logo">¿Olvidaste tu contraseña?</Link>
                  </div> */}
