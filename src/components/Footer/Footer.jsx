...
export default function Footer() {
  ...
  return (
    <footer className="p-4 md:p-8 lg:p-10 bg-gradient-secondary">
      <div className="mx-auto max-w-screen-xl text-center">
        ...
        <span className="text-sm sm:text-center text-gray-200">© 2025{" "}<Link href="https://gonzalotorresgrau.com" className="hover:underline" title="https://gonzalotorresgrau.com">Gonzalo Torres Grau</Link>. All Rights Reserved.</span>
      </div>
    </footer>
  );
}
